...
namespace Gokoukotori.PoseTune.Editor
{
    internal sealed class KawaiiMigrationOptions
    {
        ...
        public bool disableSourceKawaiiObjectAfterMigration;
        public bool tagSourceAsEditorOnly = true;
    ...
    internal static class KawaiiMigrationOptionSupport
    {
        ...
        public static string DisplaySummary(KawaiiMigrationOptions options)
        {
            ...
            var pairs = new[]
            {
                ...
                $"移行元を EditorOnly={DisplayBool(options.tagSourceAsEditorOnly)}",
                $"移行元を無効化={DisplayBool(options.disableSourceKawaiiObjectAfterMigration)}"
            };
        ...
        public static string Summary(KawaiiMigrationOptions options)
        {
            ...
            var pairs = new[]
            {
                ...
                $"tagSourceAsEditorOnly={options.tagSourceAsEditorOnly}",
                $"disableSource={options.disableSourceKawaiiObjectAfterMigration}"
            };
            return string.Join(", ", pairs.Where(pair => !string.IsNullOrWhiteSpace(pair)));
        }
